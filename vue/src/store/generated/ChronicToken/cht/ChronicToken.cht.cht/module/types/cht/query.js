...
export const protobufPackage = "ChronicToken.cht.cht";
...
export class QueryClientImpl {
    ...
    ContractInfo(request) {
        ...
        const promise = this.rpc.request("ChronicToken.cht.cht.Query", "ContractInfo", data);
    ...
    PinnedCodes(request) {
        ...
        const promise = this.rpc.request("ChronicToken.cht.cht.Query", "PinnedCodes", data);
