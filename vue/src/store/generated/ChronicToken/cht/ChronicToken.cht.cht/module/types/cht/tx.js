...
export class MsgClientImpl {
    ...
    UpdateAdmin(request) {
        ...
        const promise = this.rpc.request("ChronicToken.cht.cht.Msg", "UpdateAdmin", data);
        return promise.then((data) => MsgUpdateAdminResponse.decode(new Reader(data)));
    }
    ClearAdmin(request) {
        const data = MsgClearAdmin.encode(request).finish();
        const promise = this.rpc.request("ChronicToken.cht.cht.Msg", "ClearAdmin", data);
