...
export const QueryContractInfoRequest = {
  encode(message: QueryContractInfoRequest, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
...
export const QueryContractInfoResponse = {
  encode(message: QueryContractInfoResponse, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
      writer.uint32(10).string(message.address)
    }
...
export const QueryContractHistoryRequest = {
  encode(message: QueryContractHistoryRequest, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
      writer.uint32(10).string(message.address)
    }
...
export const QueryContractHistoryResponse = {
  encode(message: QueryContractHistoryResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryContractsByCodeRequest = {
  encode(message: QueryContractsByCodeRequest, writer: Writer = Writer.create()): Writer {
    if (message.codeId !== 0) {
...
export const QueryContractsByCodeResponse = {
  encode(message: QueryContractsByCodeResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryAllContractStateRequest = {
  encode(message: QueryAllContractStateRequest, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
      writer.uint32(10).string(message.address)
    }
    if (message.pagination !== undefined) {
...
export const QueryAllContractStateResponse = {
  encode(message: QueryAllContractStateResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryRawContractStateRequest = {
  encode(message: QueryRawContractStateRequest, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
      writer.uint32(10).string(message.address)
    }
...
export const QueryRawContractStateResponse = {
  encode(message: QueryRawContractStateResponse, writer: Writer = Writer.create()): Writer {
...
export const QuerySmartContractStateRequest = {
  encode(message: QuerySmartContractStateRequest, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
      writer.uint32(10).string(message.address)
    }
    if (message.queryData.length !== 0) {
...
export const QuerySmartContractStateResponse = {
  encode(message: QuerySmartContractStateResponse, writer: Writer = Writer.create()): Writer {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data)
    }
    return writer
...
export const QueryCodesResponse = {
  encode(message: QueryCodesResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryPinnedCodesRequest = {
  encode(message: QueryPinnedCodesRequest, writer: Writer = Writer.create()): Writer {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(18).fork()).ldelim()
    }
    return writer
...
export const QueryPinnedCodesResponse = {
  encode(message: QueryPinnedCodesResponse, writer: Writer = Writer.create()): Writer {
