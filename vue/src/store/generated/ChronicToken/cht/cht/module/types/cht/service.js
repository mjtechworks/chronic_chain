...
export class ServiceClientImpl {
    ...
    Simulate(request) {
        ...
        const promise = this.rpc.request('cht.Service', 'Simulate', data);
        return promise.then((data) => SimulateResponse.decode(new Reader(data)));
    }
    GetTx(request) {
        const data = GetTxRequest.encode(request).finish();
        const promise = this.rpc.request('cht.Service', 'GetTx', data);
        return promise.then((data) => GetTxResponse.decode(new Reader(data)));
    }
    BroadcastTx(request) {
        const data = BroadcastTxRequest.encode(request).finish();
        const promise = this.rpc.request('cht.Service', 'BroadcastTx', data);
        return promise.then((data) => BroadcastTxResponse.decode(new Reader(data)));
    }
    GetTxsEvent(request) {
        const data = GetTxsEventRequest.encode(request).finish();
        const promise = this.rpc.request('cht.Service', 'GetTxsEvent', data);
