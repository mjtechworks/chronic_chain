...
export const MsgStoreCodeResponse = {
  encode(message: MsgStoreCodeResponse, writer: Writer = Writer.create()): Writer {
    if (message.codeId !== 0) {
...
const baseMsgInstantiateContract: object = { sender: '', admin: '', codeId: 0, label: '' }

export const MsgInstantiateContract = {
  encode(message: MsgInstantiateContract, writer: Writer = Writer.create()): Writer {
    if (message.sender !== '') {
      writer.uint32(10).string(message.sender)
    }
    if (message.admin !== '') {
...
export const MsgInstantiateContractResponse = {
  encode(message: MsgInstantiateContractResponse, writer: Writer = Writer.create()): Writer {
    if (message.address !== '') {
...
export const MsgExecuteContract = {
  encode(message: MsgExecuteContract, writer: Writer = Writer.create()): Writer {
    if (message.sender !== '') {
      writer.uint32(10).string(message.sender)
    }
    if (message.contract !== '') {
...
export const MsgExecuteContractResponse = {
  encode(message: MsgExecuteContractResponse, writer: Writer = Writer.create()): Writer {
    if (message.data.length !== 0) {
...
export const MsgMigrateContract = {
  encode(message: MsgMigrateContract, writer: Writer = Writer.create()): Writer {
    if (message.sender !== '') {
      writer.uint32(10).string(message.sender)
    }
    if (message.contract !== '') {
...
export const MsgMigrateContractResponse = {
  encode(message: MsgMigrateContractResponse, writer: Writer = Writer.create()): Writer {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data)
    }
    return writer
...
export class MsgClientImpl implements Msg {
  ...
  UpdateAdmin(request: MsgUpdateAdmin): Promise<MsgUpdateAdminResponse> {
    ...
    const promise = this.rpc.request('cht.Msg', 'UpdateAdmin', data)
    return promise.then((data) => MsgUpdateAdminResponse.decode(new Reader(data)))
  }

  ClearAdmin(request: MsgClearAdmin): Promise<MsgClearAdminResponse> {
    const data = MsgClearAdmin.encode(request).finish()
    const promise = this.rpc.request('cht.Msg', 'ClearAdmin', data)
