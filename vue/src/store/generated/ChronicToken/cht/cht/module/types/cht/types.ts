...
const baseParams: object = { instantiateDefaultPermission: 0, maxWasmCodeSize: 0 }
...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          message.maxWasmCodeSize = longToNumber(reader.uint64() as Long)
          break
        default:
          reader.skipType(tag & 7)
          break
  ...
  fromJSON(object: any): Params {
    ...
    if (object.maxWasmCodeSize !== undefined && object.maxWasmCodeSize !== null) {
      message.maxWasmCodeSize = Number(object.maxWasmCodeSize)
    } else {
      message.maxWasmCodeSize = 0
    }
    return message
  },
...
const baseContractInfo: object = { codeId: 0, creator: '', admin: '', label: '', ibcPortId: '' }
...
export const ContractCodeHistoryEntry = {
  encode(message: ContractCodeHistoryEntry, writer: Writer = Writer.create()): Writer {
...
export const AbsoluteTxPosition = {
  encode(message: AbsoluteTxPosition, writer: Writer = Writer.create()): Writer {
