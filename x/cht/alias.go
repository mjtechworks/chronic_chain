...
// ALIASGEN: cht/x/cht/types
// ALIASGEN: cht/x/cht/keeper
package cht
...
var (
	...
	NewEnv                    = types.NewEnv
	NewWasmCoins              = types.NewChronicCoins
	DefaultChronicConfig      = types.DefaultChronicConfig
