...
// GenesisInstantiateContractCmd cli command to add a `MsgInstantiateContract` to the cht section of the genesis
// that is executed on block 0.
...
// GenesisExecuteContractCmd cli command to add a `MsgExecuteContract` to the cht section of the genesis
// that is executed on block 0.
...
// GenesisListCodesCmd cli command to list all codes stored in the genesis cht.code section
// as well as from messages that are queued in the cht.genMsgs section.
...
// GenesisListContractsCmd cli command to list all contracts stored in the genesis cht.contract section
// as well as from messages that are queued in the cht.genMsgs section.
