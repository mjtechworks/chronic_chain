...
func GetQueryCmd() *cobra.Command {
	queryCmd := &cobra.Command{
		...
		Short:                      "Querying commands for the cht module",
...
// GetCmdListCode lists all cht code uploaded
func GetCmdListCode() *cobra.Command {
	cmd := &cobra.Command{
		Use:     "list-code",
		Short:   "List all cht bytecode on the chain",
		Long:    "List all cht bytecode on the chain",
...
// GetCmdListContractByCode lists all cht code uploaded for given code id
func GetCmdListContractByCode() *cobra.Command {
	cmd := &cobra.Command{
		Use:     "list-contract-by-code [code_id]",
		Short:   "List cht all bytecode on the chain for given code id",
		Long:    "List cht all bytecode on the chain for given code id",
...
func GetCmdQueryCode() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short:   "Downloads cht bytecode for given code id",
		Long:    "Downloads cht bytecode for given code id",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Printf("Downloading cht code to %s\n", args[1])
...
// GetCmdListPinnedCode lists all cht code ids that are pinned
