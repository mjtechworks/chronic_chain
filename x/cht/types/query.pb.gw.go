...
var (
	pattern_Query_ContractInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"cht", "contract", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ContractHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"cht", "contract", "address", "history"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ContractsByCode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"cht", "code", "code_id", "contracts"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AllContractState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"cht", "contract", "address", "state"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RawContractState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"cht", "contract", "address", "raw", "query_data"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_SmartContractState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"cht", "contract", "address", "smart", "query_data"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Code_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"cht", "code", "code_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Codes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cht", "code"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PinnedCodes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"cht", "codes", "pinned"}, "", runtime.AssumeColonVerbOpt(true)))
)
